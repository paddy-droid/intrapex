...
export const metadata: Metadata = {
    title: "Gießerei Kärnten | Industrie- & Kunstguss Intrapex",
    description: "Ihr zuverlässiger Gießerei-Partner für Kärnten. Wir liefern hochwertigen Grauguss, Sphäroguss und Stiegenziergitter direkt zu Ihrem Bauprojekt in Kärnten.",
    keywords: ["Gießerei Kärnten", "Kunstguss Kärnten", "Grauguss Kärnten", "Gießerei Österreich", "Stiegenziergitter Kärnten"],
};
        ...
        <div className="flex flex-col w-full bg-slate-50">
            ...
            <section className="relative w-full h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div className="container relative z-20 px-4 text-center">
                    <span className="inline-block py-1 px-3 rounded-full bg-orange-600/20 border border-orange-500/50 text-orange-200 text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-sm">
                        Ihr Partner für Kärnten
                    </span>
                    <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-6 leading-tight">
                        Gießerei-Service <br className="hidden md:block" />
                        <span className="text-orange-500">für Kärnten</span>
                    </h1>
                    <p className="text-slate-200 max-w-2xl mx-auto text-xl font-light mb-10">
                        Top-Qualität für Ihre Projekte im Süden Österreichs. Wir beliefern Klagenfurt, Villach und ganz Kärnten mit erstklassigen Gusslösungen.
                    </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl font-serif font-bold text-slate-900 mb-6">
                                Qualität für Kärntner Projekte
                            </h2>
                            <p className="text-slate-600 text-lg leading-relaxed mb-6">
                                Ob filigrane Stiegenziergitter für die Villa am Wörthersee oder robuste Maschinenteile für die Kärntner Industrie – wir liefern die passende Lösung.
                            </p>
                            <p className="text-slate-600 text-lg leading-relaxed mb-8">
                                Durch unsere optimierte Logistik sind wir auch im Süden Österreichs ein starker Partner. Verlassen Sie sich auf österreichische Qualität Standards.
                            </p>
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    <MapPin className="h-6 w-6 text-orange-600 flex-shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-slate-900">Lieferung nach Kärnten</h4>
                                        <p className="text-sm text-slate-500">Sicherer Transport direkt zu Ihnen.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Box className="h-6 w-6 text-orange-600 flex-shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-slate-900">Vielfältiges Angebot</h4>
                                        <p className="text-sm text-slate-500">Kanalguss, Maschinenguss, Kunstguss.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl group">
                            <Image
                                ...
                                alt="Stiegenziergitter in Kärnten"
                                fill
                            ...
                            <div className="absolute bottom-6 left-6 right-6">
                                <div className="bg-white/90 backdrop-blur-sm p-4 rounded-xl border-l-4 border-orange-500">
                                    <p className="font-bold text-slate-900">Ästhetik & Funktion</p>
                                    <p className="text-sm text-slate-600">Hochwertige Gusslösungen.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-slate-100">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mt-2">Gusslösungen für Kärnten</h2>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { icon: Layers, title: "Industrieguss", desc: "Komponenten für Maschinen und Anlagen." },
                            { icon: Hammer, title: "Kunstguss", desc: "Zäune, Gitter und Säulen nach Maß." },
                            { icon: Compass, title: "Projektierung", desc: "Beratung von der Idee bis zum Guss." },
                            { icon: Truck, title: "Versand", desc: "Zuverlässige Zustellung nach Kärnten." }
                        ].map((item, idx) => (
            ...
            <section className="py-24 bg-slate-900 text-center">
                <div className="container px-4">
                    <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">Ihr Partner für Kärnten</h2>
