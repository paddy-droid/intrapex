...
export const metadata: Metadata = {
    title: "Gießerei Tirol | Industrie- & Kunstguss Intrapex",
    description: "Ihr zuverlässiger Gießerei-Partner für Tirol. Wir liefern hochwertigen Grauguss, Sphäroguss und Stiegenziergitter direkt zu Ihrem Bauprojekt in Tirol.",
    keywords: ["Gießerei Tirol", "Kunstguss Tirol", "Grauguss Tirol", "Gießerei Österreich", "Stiegenziergitter Tirol"],
};
        ...
        <div className="flex flex-col w-full bg-slate-50">
            ...
            <section className="relative w-full h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div className="container relative z-20 px-4 text-center">
                    <span className="inline-block py-1 px-3 rounded-full bg-orange-600/20 border border-orange-500/50 text-orange-200 text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-sm">
                        Ihr Partner für Tirol
                    </span>
                    <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-6 leading-tight">
                        Gießerei-Exzellenz <br className="hidden md:block" />
                        <span className="text-orange-500">für Tirol</span>
                    </h1>
                    <p className="text-slate-200 max-w-2xl mx-auto text-xl font-light mb-10">
                        Innsbruck, Kitzbühel oder Lienz – wir sind Ihr Partner für hochwertige Gusslösungen in ganz Tirol. Qualität ohne Kompromisse.
                    </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl font-serif font-bold text-slate-900 mb-6">
                                Gusslösungen für Tiroler Ansprüche
                            </h2>
                            <p className="text-slate-600 text-lg leading-relaxed mb-6">
                                Alpine Architektur und robuste Industrieanforderungen treffen in Tirol aufeinander. Wir bieten für beide Bereiche maßgeschneiderte Lösungen.
                            </p>
                            <p className="text-slate-600 text-lg leading-relaxed mb-8">
                                Unsere Logistikpartner sorgen für eine reibungslose Lieferung in alle Tiroler Bezirke. Vertrauen Sie auf unsere Erfahrung bei Denkmalschutz und Industrieguss.
                            </p>
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    <MapPin className="h-6 w-6 text-orange-600 flex-shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-slate-900">Tirol-weiter Versand</h4>
                                        <p className="text-sm text-slate-500">Zuverlässig nach Innsbruck und in die Talschaften.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Box className="h-6 w-6 text-orange-600 flex-shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-slate-900">Spezialanfertigungen</h4>
                                        <p className="text-sm text-slate-500">Gussteile, die extremen Bedingungen standhalten.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl group">
                            ...
                            <div className="absolute bottom-6 left-6 right-6">
                                <div className="bg-white/90 backdrop-blur-sm p-4 rounded-xl border-l-4 border-orange-500">
                                    <p className="font-bold text-slate-900">Robust & Langlebig</p>
                                    <p className="text-sm text-slate-600">Qualität, die überdauert.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-slate-100">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mt-2">Gusslösungen für Tirol</h2>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { icon: Layers, title: "Serienguss", desc: "Präzisionsteile für die Industrie." },
                            { icon: Hammer, title: "Sonderguss", desc: "Architekturelemente und Kunstguss." },
                            { icon: Compass, title: "Beratung", desc: "Fachkompetenz von Anfang an." },
                            { icon: Truck, title: "Logistik", desc: "Lieferung direkt nach Tirol." }
                        ].map((item, idx) => (
            ...
            <section className="py-24 bg-slate-900 text-center">
                <div className="container px-4">
                    <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">Ihr Partner für Tirol</h2>
